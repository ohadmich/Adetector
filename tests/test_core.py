...
class TestCore(unittest.TestCase):
    ...
    def test_get_timestamps_output_shape(self):
        timestamps, probs = adt.core.get_timestamps(self.prob_over_time_sample, n=1)
    ...
    def test_get_timestamps_boundary_conditions(self):
        ...
        right_detection, right_probs = adt.core.get_timestamps(right_signal, n=1)
    ...
    def test_Ad_vs_speech_classifier_output_shape(self):
        probs = adt.core.Ad_vs_speech_classifier(self.X_sample, self.timestamps_sample,
